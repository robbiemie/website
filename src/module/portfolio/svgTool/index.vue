          ...
          <defs>
              <g id="groupText">
                ...
                <text id="text" :filter="getTextFilter" :font-weight="style.fontWeight" font-family="Verdana" :stroke="style.strokeColor"
                  ...
                  <textPath xlink:href="#myPath" startOffset="52%">
...
import LinkGithub from '@/component/link/LinkGithub'
import LinkPortfolio from '@/component/link/LinkPortfolio'
...
export default {
  ...
  data () {
    return {
      base: {
        ...
        percenth: 0,
        split: 0.5,
        d: 'M0 100 C 270 0, 540 0, 800 100',
        dasharray: '0',
  ...
  methods: {
    ...
    addDemo () {
      ...
      script.src = '//jsfiddle.net/vicharles/hfub7823/3/embed/html,css,result'
...
<style lang="scss">
@import url(https://unpkg.com/iview@3.1.4/dist/styles/iview.css);
.svgtool {
  height: 100%;
  overflow: hidden;
}
